...
(cd src/AccelByte.PluginArch.SessionDsm.Demo.Server && dotnet run) & GRPC_SERVER_PID=$!
...
(cd src/AccelByte.PluginArch.SessionDsm.Demo.Client && dotnet run -- --grpc-target ${NGROK_URL#*://})
