# session-dsm-grpc-plugin-csharp

An Extend Override app for the **session DSM** (Dedicated Server Management) written in C#. AGS calls this gRPC server to create and terminate dedicated game server sessions.
...
| Path | Purpose |
|---|---|
| `src/AccelByte.PluginArch.SessionDsm.Demo.Server/Program.cs` | Entry point — starts gRPC server, wires interceptors and observability |
| `src/AccelByte.PluginArch.SessionDsm.Demo.Server/Classes/DefaultAccelByteServiceProvider.cs` | **Service implementation** — your custom logic goes here |
| `src/AccelByte.PluginArch.SessionDsm.Demo.Server/Model/ServerServiceType.cs` | **Service implementation** — your custom logic goes here |
| `src/AccelByte.PluginArch.SessionDsm.Demo.Server/Protos/session-dsm.proto` | gRPC service definition (AccelByte-provided, do not modify) |
| `src/AccelByte.PluginArch.SessionDsm.Demo.Server/Protos/` | Generated code from proto (do not hand-edit) |
